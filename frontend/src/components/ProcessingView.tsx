...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    title: 'Extracting palette & DNA',
    description: 'Analyzing colors, tone, values and archetype',
    duration: 3000,
  },
  {
    id: 'strategy',
    ...
    description: 'Matching brand with platform best practices',
    duration: 2500,
  },
  {
    id: 'content',
    ...
    description: 'Creating posts for LinkedIn, Instagram & Facebook',
    duration: 3500,
  },
  {
    id: 'images',
    ...
    description: 'Creating visuals with Flux',
    duration: 60000,
  },
]
